...
pub fn Home() -> impl IntoView {
    ...
    view! {
        ...
        min-h-[580px] w-full
                    ...
                    transition-transform duration-200 hover:scale-[1.025]">
                                ...
                                <Text variant=TextVariant::Black class="text-lg font-bold text-indigo-900 mt-2 text-center">
    ...
    {WORK_EXPERIENCES.iter().map(|exp| view! {
        <li class="p-4 bg-white dark:bg-white rounded-xl shadow border-1">
            ...
            <Text size=TextSize::Sm variant=TextVariant::Black class="text-md italic">
                {exp.company}
            </Text>
            <Text size=TextSize::Sm variant=TextVariant::Black class="text-md">
                {exp.period}
            </Text>
